...
public class ChatPanel extends JPanel {
    ...
    public void addText(String text) {
        ...
        // Check if the message is a special command (/flip or /roll)
        boolean isSpecialCommand = text.startsWith("/flip") || text.startsWith("/roll");
        //UCID: fm362 Date: 04/16/2024
        // Check if the message is a private message (starts with @)
        boolean isPrivateMessage = text.startsWith("@");
        // add message
        ...
        //UCID:fm362 Date:04/15/2024
        if (isSpecialCommand) {
            // the appearance for special commands
            textContainer.setBackground(Color.GREEN);
        } else if (isPrivateMessage) {
            // Yellow background for private messages
            textContainer.setBackground(Color.YELLOW);
        } else {
            // default formatting for regular chat text
